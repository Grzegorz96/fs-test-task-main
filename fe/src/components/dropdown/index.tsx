      ...
      <Listbox value={selected} onChange={handleChange}>
        <div className="relative mt-1">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto bg-white text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm z-10">
              <Listbox.Option
                key="all"
                value={{ name: '' }}
                className={({ active }) =>
